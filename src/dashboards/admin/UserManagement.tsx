...
<h3 className="text-sm font-bold text-dealer-on-surface-variant uppercase tracking-widest">Security Logs</h3>
...
<div className="flex items-center justify-between mb-4">
<h4 className="text-xs font-bold text-dealer-outline uppercase tracking-widest">Associated Permission Group</h4>
...
<p className="text-[10px] font-bold opacity-80 uppercase tracking-widest mb-1">Trust Score</p>
