...
<div>
<h1 className="text-3xl font-extrabold tracking-tight text-dealer-on-background mb-1">Network Dealerships</h1>
<p className="text-dealer-on-surface-variant font-medium">Oversee the entire global dealership network status.</p>
</div>
...
<p className="text-sm font-medium text-dealer-on-surface-variant mb-2">Total Network Dealerships</p>
...
<div className="bg-dealer-surface-container-lowest p-6 rounded-2xl shadow-sm border border-transparent hover:border-dealer-outline-variant/20 transition-all">
<p className="text-sm font-medium text-dealer-on-surface-variant mb-2">Network Dealerships Value</p>
<div className="flex items-baseline gap-2">
...
<a className="text-xs font-bold text-dealer-primary hover:underline" href="#">Network Dealerships Settings</a>
</div>
</div>
</div>
</main>
