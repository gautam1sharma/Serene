...
<h3 className="text-sm font-bold text-dealer-on-surface-variant uppercase tracking-widest">Upcoming Drives</h3>
...
<p className="text-[10px] font-bold opacity-80 uppercase tracking-widest mb-1">Arrival Confidence</p>
...
<span className="text-xs font-bold text-dealer-on-surface">Booking Confirmed</span>
...
<span className="material-symbols-outlined text-4xl text-dealer-outline-variant" data-icon="event">chat_bubble</span>
</div>
