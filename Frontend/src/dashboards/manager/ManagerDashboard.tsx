            ...
            <main className="max-w-[1920px] mx-auto px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-dealer-surface-container-lowest p-6 rounded-2xl shadow-[0px_12px_32px_rgba(30,41,59,0.03)] flex flex-col justify-between h-40">
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-medium text-dealer-on-surface-variant">Awaiting response</span>
                            <div className="h-8 w-24">
                    ...
                    <div className="bg-dealer-surface-container-lowest p-6 rounded-2xl shadow-[0px_12px_32px_rgba(30,41,59,0.03)] flex flex-col justify-between h-40">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-xs font-semibold text-dealer-on-surface-variant tracking-wider uppercase">Test Drives</p>
                                <h2 className="text-3xl font-extrabold font-headline mt-1">
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-xs font-medium text-dealer-on-surface-variant">Scheduled / Pending</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2 bg-dealer-surface-container-lowest rounded-3xl shadow-[0px_12px_32px_rgba(30,41,59,0.03)] overflow-hidden">
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            <h3 className="text-lg font-bold font-headline text-dealer-on-surface">Sales Summary</h3>
                        </div>
                        <div className="p-6 grid grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-dealer-surface-container-low rounded-2xl">
                                ...
                                <p className="text-xs font-medium text-dealer-on-surface-variant mt-1">Units Sold</p>
                            </div>
                            <div className="text-center p-4 bg-dealer-surface-container-low rounded-2xl">
                                <p className="text-2xl font-extrabold font-headline text-dealer-on-surface">
                                    {loading ? '—' : (metrics?.totalUsers ?? 0)}
                                </p>
                                <p className="text-xs font-medium text-dealer-on-surface-variant mt-1">Customers</p>
                            </div>
                            <div className="text-center p-4 bg-dealer-primary rounded-2xl">
                                ...
                                <p className="text-xs font-medium text-dealer-on-primary/80 mt-1">Revenue</p>
                            </div>
                        </div>
                    </div>

                    {/* Right: Upcoming Test Drives */}
                    <div className="bg-dealer-surface-container-lowest rounded-3xl shadow-[0px_12px_32px_rgba(30,41,59,0.03)] flex flex-col items-center justify-center p-8 text-center min-h-[200px]">
                        <div className="mb-4 opacity-20">
                            <span className="material-symbols-outlined text-6xl">tire_repair</span>
                        </div>
                        <h3 className="text-lg font-bold font-headline text-dealer-on-surface">
                            {loading ? '—' : (metrics?.upcomingTestDrives ?? 0)} Upcoming
                        </h3>
                        <p className="text-dealer-on-surface-variant text-sm mt-2 max-w-[200px] mx-auto">
                            Test drives pending or confirmed
                        </p>
                    </div>
                </div>
